...
public final class ExternalHardwareConstants {
    ...
    public static final class ServoImplConstants {
        ...
        RIGHT_EXTENSION_SERVO_MAXIMUM = 4.0 / 18.0, RIGHT_CLAW_MAX_ROTATION = -5, CLAW_MAX_ROTATION =  0.75,
        CLAW_MIN_ROTATION = 0.6, LEFT_CLAW_MAX_ROTATION = -25, CLAW_MAXIMUM = 180, CLAW_MINIMUM = -180,
                LEFT_CLAW_MAX_FOAM_PIECE_ROTATION = 0, RIGHT_CLAW_MAX_FOAM_PIECE_ROTATION = 0, ABSOLUTE_MIN_POSITION = 0,
        BASKET_MAX_POSITION = 0.25, GROUND_MAX_POSITION = 0.6;

        public enum ServoType {
            LEFT_EXTENSION("servo", false, LEFT_EXTENSION_SERVO_MINIMUM, LEFT_EXTENSION_SERVO_MAXIMUM),

            RIGHT_EXTENSION("servo2", true, RIGHT_EXTENSION_SERVO_MINIMUM, RIGHT_EXTENSION_SERVO_MAXIMUM),
